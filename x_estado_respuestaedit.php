...
$x_estado_respuesta_edit = NULL; // Initialize page object first

class cx_estado_respuesta_edit extends cx_estado_respuesta {
	...
	// Page object name
	var $PageObjName = 'x_estado_respuesta_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->id_x_estado_respuesta->CurrentValue == "")
			$this->Page_Terminate("x_estado_respuestalist.php"); // Invalid key, return to list
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$this->id_x_estado_respuesta->EditValue = $this->id_x_estado_respuesta->CurrentValue;
			$this->id_x_estado_respuesta->ViewCustomAttributes = "";
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			$this->estado_respuesta->SetDbValueDef($rsnew, $this->estado_respuesta->CurrentValue, "", $this->estado_respuesta->ReadOnly);
...
// Create page object
if (!isset($x_estado_respuesta_edit)) $x_estado_respuesta_edit = new cx_estado_respuesta_edit();

// Page init
$x_estado_respuesta_edit->Page_Init();

// Page main
$x_estado_respuesta_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$x_estado_respuesta_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var x_estado_respuesta_edit = new ew_Page("x_estado_respuesta_edit");
x_estado_respuesta_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = x_estado_respuesta_edit.PageID; // For backward compatibility

// Form object
var fx_estado_respuestaedit = new ew_Form("fx_estado_respuestaedit");

// Validate form
fx_estado_respuestaedit.Validate = function() {
...
fx_estado_respuestaedit.Form_CustomValidate = 
...
fx_estado_respuestaedit.ValidateRequired = true;
<?php } else { ?>
fx_estado_respuestaedit.ValidateRequired = false; 
<?php } ?>
...
<?php $x_estado_respuesta_edit->ShowPageHeader(); ?>
<?php
$x_estado_respuesta_edit->ShowMessage();
?>
<form name="fx_estado_respuestaedit" id="fx_estado_respuestaedit" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="x_estado_respuesta">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewGrid"><tr><td>
<table id="tbl_x_estado_respuestaedit" class="table table-bordered table-striped">
...
<?php echo $x_estado_respuesta->id_x_estado_respuesta->EditValue ?></span>
</span>
<input type="hidden" data-field="x_id_x_estado_respuesta" name="x_id_x_estado_respuesta" id="x_id_x_estado_respuesta" value="<?php echo ew_HtmlEncode($x_estado_respuesta->id_x_estado_respuesta->CurrentValue) ?>">
...
<script type="text/javascript">
fx_estado_respuestaedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$x_estado_respuesta_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$x_estado_respuesta_edit->Page_Terminate();
?>
