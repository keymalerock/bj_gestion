...
$matricula_add = NULL; // Initialize page object first

class cmatricula_add extends cmatricula {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["id_matricula"] != "") {
				...
				$this->setKey("id_matricula", $this->id_matricula->CurrentValue); // Set up key
			} else {
				$this->setKey("id_matricula", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "matriculaview.php")
	...
	function LoadDefaultValues() {
		...
		$this->bol_matri->CurrentValue = NULL;
		$this->bol_matri->OldValue = $this->bol_matri->CurrentValue;
		$this->cuenta_matri->CurrentValue = NULL;
		$this->cuenta_matri->OldValue = $this->cuenta_matri->CurrentValue;
		$this->termino1_matri->CurrentValue = NULL;
		$this->termino1_matri->OldValue = $this->termino1_matri->CurrentValue;
		$this->termino2_matri->CurrentValue = NULL;
		$this->termino2_matri->OldValue = $this->termino2_matri->CurrentValue;
		$this->termino3_matri->CurrentValue = NULL;
		$this->termino3_matri->OldValue = $this->termino3_matri->CurrentValue;
		$this->pag_card_matri->CurrentValue = NULL;
		$this->pag_card_matri->OldValue = $this->pag_card_matri->CurrentValue;
		$this->tipo_card_matri->CurrentValue = NULL;
		$this->tipo_card_matri->OldValue = $this->tipo_card_matri->CurrentValue;
		$this->num_card_matri->CurrentValue = NULL;
		$this->num_card_matri->OldValue = $this->num_card_matri->CurrentValue;
		$this->venc_card_matri->CurrentValue = NULL;
		$this->venc_card_matri->OldValue = $this->venc_card_matri->CurrentValue;
		$this->doc1_matri->CurrentValue = NULL;
		$this->doc1_matri->OldValue = $this->doc1_matri->CurrentValue;
		$this->doc2_matri->CurrentValue = NULL;
		$this->doc2_matri->OldValue = $this->doc2_matri->CurrentValue;
		$this->doc3_matri->CurrentValue = NULL;
		$this->doc3_matri->OldValue = $this->doc3_matri->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// bol_matri
		$this->bol_matri->SetDbValueDef($rsnew, $this->bol_matri->CurrentValue, NULL, FALSE);

		// cuenta_matri
		$this->cuenta_matri->SetDbValueDef($rsnew, $this->cuenta_matri->CurrentValue, NULL, FALSE);

		// termino1_matri
		$this->termino1_matri->SetDbValueDef($rsnew, $this->termino1_matri->CurrentValue, NULL, FALSE);

		// termino2_matri
		$this->termino2_matri->SetDbValueDef($rsnew, $this->termino2_matri->CurrentValue, NULL, FALSE);

		// termino3_matri
		$this->termino3_matri->SetDbValueDef($rsnew, $this->termino3_matri->CurrentValue, NULL, FALSE);

		// pag_card_matri
		$this->pag_card_matri->SetDbValueDef($rsnew, $this->pag_card_matri->CurrentValue, NULL, FALSE);

		// tipo_card_matri
		$this->tipo_card_matri->SetDbValueDef($rsnew, $this->tipo_card_matri->CurrentValue, NULL, FALSE);

		// num_card_matri
		$this->num_card_matri->SetDbValueDef($rsnew, $this->num_card_matri->CurrentValue, NULL, FALSE);

		// venc_card_matri
		$this->venc_card_matri->SetDbValueDef($rsnew, $this->venc_card_matri->CurrentValue, NULL, FALSE);

		// doc1_matri
		$this->doc1_matri->SetDbValueDef($rsnew, $this->doc1_matri->CurrentValue, NULL, FALSE);

		// doc2_matri
		$this->doc2_matri->SetDbValueDef($rsnew, $this->doc2_matri->CurrentValue, NULL, FALSE);

		// doc3_matri
		$this->doc3_matri->SetDbValueDef($rsnew, $this->doc3_matri->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($matricula_add)) $matricula_add = new cmatricula_add();

// Page init
$matricula_add->Page_Init();

// Page main
$matricula_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$matricula_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var matricula_add = new ew_Page("matricula_add");
matricula_add.PageID = "add"; // Page ID
var EW_PAGE_ID = matricula_add.PageID; // For backward compatibility

// Form object
var fmatriculaadd = new ew_Form("fmatriculaadd");

// Validate form
fmatriculaadd.Validate = function() {
...
fmatriculaadd.Form_CustomValidate = 
...
fmatriculaadd.ValidateRequired = true;
<?php } else { ?>
fmatriculaadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmatriculaadd.Lists["x_id_afiliado"] = {"LinkField":"x_id_afiliado","Ajax":true,"AutoFill":false,"DisplayFields":["x_dociden_afiliado","x_apell_afiliado","x_nomb_afiliado",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fmatriculaadd.Lists["x_id_plan"] = {"LinkField":"x_id_plan","Ajax":null,"AutoFill":false,"DisplayFields":["x_tipo_plan","x_time_plan","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $matricula_add->ShowPageHeader(); ?>
<?php
$matricula_add->ShowMessage();
?>
<form name="fmatriculaadd" id="fmatriculaadd" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="matricula">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_matriculaadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
var oas = new ew_AutoSuggest("x_id_afiliado", fmatriculaadd, false, EW_AUTO_SUGGEST_MAX_ENTRIES);
...
fmatriculaadd.AutoSuggests["x_id_afiliado"] = oas;
</script>
<?php } ?>
...
<script type="text/javascript">
fmatriculaadd.Lists["x_id_plan"].Options = <?php echo (is_array($matricula->id_plan->EditValue)) ? ew_ArrayToJson($matricula->id_plan->EditValue, 1) : "[]" ?>;
</script>
</span>
