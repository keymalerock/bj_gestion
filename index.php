...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'afiliado'))
		$this->Page_Terminate("afiliadolist.php"); // Exit and go to default page
		...
		if ($Security->AllowList(CurrentProjectID() . 'novedad'))
			$this->Page_Terminate("novedadlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'plan'))
		...
		if ($Security->AllowList(CurrentProjectID() . 'x_estado_respuesta'))
		...
		if ($Security->AllowList(CurrentProjectID() . 'notificacion'))
			$this->Page_Terminate("notificacionlist.php");
			$this->Page_Terminate("v_novedadeslist.php");
