...
class clogin extends cv_usuarios {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["v_usuarios"]) || get_class($GLOBALS["v_usuarios"]) == "cv_usuarios") {
			$GLOBALS["v_usuarios"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["v_usuarios"];
		}
		if (!isset($GLOBALS["v_usuarios"])) $GLOBALS["v_usuarios"] = &$this;
