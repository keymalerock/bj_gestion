...
define("EW_PROJECT_NAME", "Proyecto_bj", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{CD332243-68AB-4368-BF10-F24F7E84F4D6}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'Ats53V2OKhpX77rZ', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/Proyecto_bj.css", TRUE); // Project stylesheet file name
...
// User table filters
define("EW_USER_TABLE", "`v_usuarios`",  TRUE);
define("EW_USER_NAME_FILTER", "(`login_empleado` = '%u')",  TRUE);
