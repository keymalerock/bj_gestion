	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["id_representante"] != "") {
				...
				$this->setKey("id_representante", $this->id_representante->CurrentValue); // Set up key
			} else {
				$this->setKey("id_representante", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "representantesview.php")
...
// Page object
var representantes_add = new ew_Page("representantes_add");
representantes_add.PageID = "add"; // Page ID
var EW_PAGE_ID = representantes_add.PageID; // For backward compatibility

// Form object
var frepresentantesadd = new ew_Form("frepresentantesadd");
...
frepresentantesadd.ValidateRequired = true;
<?php } else { ?>
frepresentantesadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
frepresentantesadd.Lists["x_id_afiliado"] = {"LinkField":"x_id_afiliado","Ajax":true,"AutoFill":false,"DisplayFields":["x_apell_afiliado","x_nomb_afiliado","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="frepresentantesadd" id="frepresentantesadd" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="representantes">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_representantesadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
var oas = new ew_AutoSuggest("x_id_afiliado", frepresentantesadd, true, EW_AUTO_SUGGEST_MAX_ENTRIES);
...
frepresentantesadd.AutoSuggests["x_id_afiliado"] = oas;
</script>
<?php } ?>
