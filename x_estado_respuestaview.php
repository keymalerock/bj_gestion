...
$x_estado_respuesta_view = NULL; // Initialize page object first

class cx_estado_respuesta_view extends cx_estado_respuesta {
	...
	// Page object name
	var $PageObjName = 'x_estado_respuesta_view';
	...
	function __construct() {
		...
		if (@$_GET["id_x_estado_respuesta"] <> "") {
			$this->RecKey["id_x_estado_respuesta"] = $_GET["id_x_estado_respuesta"];
			$KeyUrl .= "&amp;id_x_estado_respuesta=" . urlencode($this->RecKey["id_x_estado_respuesta"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id_x_estado_respuesta"] <> "") {
				...
				$this->RecKey["id_x_estado_respuesta"] = $this->id_x_estado_respuesta->QueryStringValue;
			} else {
				$sReturnUrl = "x_estado_respuestalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "x_estado_respuestalist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "x_estado_respuestalist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($x_estado_respuesta_view)) $x_estado_respuesta_view = new cx_estado_respuesta_view();

// Page init
$x_estado_respuesta_view->Page_Init();

// Page main
$x_estado_respuesta_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$x_estado_respuesta_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var x_estado_respuesta_view = new ew_Page("x_estado_respuesta_view");
x_estado_respuesta_view.PageID = "view"; // Page ID
var EW_PAGE_ID = x_estado_respuesta_view.PageID; // For backward compatibility

// Form object
var fx_estado_respuestaview = new ew_Form("fx_estado_respuestaview");

// Form_CustomValidate event
fx_estado_respuestaview.Form_CustomValidate = 
...
fx_estado_respuestaview.ValidateRequired = true;
<?php } else { ?>
fx_estado_respuestaview.ValidateRequired = false; 
<?php } ?>
...
<?php $x_estado_respuesta_view->ExportOptions->Render("body") ?>
<?php if (!$x_estado_respuesta_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($x_estado_respuesta_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $x_estado_respuesta_view->ShowPageHeader(); ?>
<?php
$x_estado_respuesta_view->ShowMessage();
?>
<form name="fx_estado_respuestaview" id="fx_estado_respuestaview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="x_estado_respuesta">
<table class="ewGrid"><tr><td>
<table id="tbl_x_estado_respuestaview" class="table table-bordered table-striped">
<?php if ($x_estado_respuesta->id_x_estado_respuesta->Visible) { // id_x_estado_respuesta ?>
	<tr id="r_id_x_estado_respuesta">
		<td><span id="elh_x_estado_respuesta_id_x_estado_respuesta"><?php echo $x_estado_respuesta->id_x_estado_respuesta->FldCaption() ?></span></td>
...
<?php echo $x_estado_respuesta->id_x_estado_respuesta->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($x_estado_respuesta->estado_respuesta->Visible) { // estado_respuesta ?>
	<tr id="r_estado_respuesta">
		<td><span id="elh_x_estado_respuesta_estado_respuesta"><?php echo $x_estado_respuesta->estado_respuesta->FldCaption() ?></span></td>
...
<?php echo $x_estado_respuesta->estado_respuesta->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($x_estado_respuesta->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_x_estado_respuesta_status"><?php echo $x_estado_respuesta->status->FldCaption() ?></span></td>
...
<?php echo $x_estado_respuesta->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fx_estado_respuestaview.Init();
</script>
<?php
$x_estado_respuesta_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$x_estado_respuesta_view->Page_Terminate();
?>
